...
\begin{titlepage}
    \begin{center}
        ...
        {\small 12 Interactive Screens \textbullet{} Complete Prototype \textbullet{} HTML/CSS/JS}\\[8pt]
        {\small Live Demo: \url{https://quickbite-4h67.onrender.com}}\\[4pt]
        {\small GitHub: \url{https://github.com/Niranjan7771/HCI_MID}}
    \end{center}
\end{titlepage}
